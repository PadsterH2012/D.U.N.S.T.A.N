from shared.models.models import Character, SessionLocal  # Ensure the correct import
...
from shared.models.models import db  # Use the Flask-SQLAlchemy db object
